...
SELECT
    ...
    argMax(ft.bank_state, ft.updated_at)          AS bank_state,
    argMax(ft.bank_decline_reason, ft.updated_at) AS bank_decline_reason,
    ...
    argMax(ft.bank_failed_at, ft.updated_at)      AS bank_failed_at,
    argMax(ft.fee_amount_cents, ft.updated_at)    AS fee_amount_cents,
